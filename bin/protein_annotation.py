...
def main():
    ...
    columns = ['organism_name', 'organism_id',  'accession', 'gene_names', 
        ...
        'xref_supfam', 'xref_tigrfams','xref_ccds', 'xref_embl', 'xref_pir', 
    ...
    annotation_sets = {
        ...
        'seq_xfamdom': ['organism_name', 'organism_id', 'accession', 'xref_cdd', 'xref_disprot', 'xref_gene3d', 'xref_hamap','xref_ideal', 'xref_interpro', 'xref_panther', 'xref_pirsf','xref_prints', 'xref_prosite', 'xref_pfam', 'xref_prodom','xref_sfld', 'xref_smart', 'xref_supfam', 'xref_tigrfams'],
