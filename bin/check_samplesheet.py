...
def check_samplesheet(file_in, file_out):
    ...
    with open(file_in, "r", encoding="utf-8-sig") as fin:
        ...
        for line in fin:
            if line.strip():
                ...
                species, file, tax1, tax2 = lspl[: len(HEADER)]
                if species.find(" ") != -1:
                ...
                species_info = [file, tax1, tax2]  ## [file, tax1, tax2]

                ## Create species mapping dictionary = {species: [[ file, tax1, tax2 ]]}
    ...
    if len(species_mapping_dict) > 0:
        ...
        with open(file_out, "w") as fout:
            fout.write(",".join(["species", "file", "tax1", "tax2"]) + "\n")
