...
## Outputs
<details>
  <summary>Expand for a description of workflow outputs, namely directory structure and their contents, produced from an end-to-end run of the workflow. This description will be updated as development progresses.</summary>
  <br/>
